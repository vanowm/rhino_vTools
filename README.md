...
- Native commands:
  ...
  - [vSplit](#vsplit-flow) *(26.7.10.1540)* — interactively splits selected curves at picked real point markers with cyan remove preview, point snapping, and Undo/Redo
