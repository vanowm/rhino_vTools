...
- Native commands (44):
  ...
  - [vFilterExec](#vfilterexec-flow) *(26.7.30.1206)* — runs a command with a temporary selection filter and restores the previous filter afterward
...
1. `vFilterExec` is transparent, remembers its command and filter, and remains the Repeat command after the delegated command ends.
